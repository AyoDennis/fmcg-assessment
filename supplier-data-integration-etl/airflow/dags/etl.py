...
def extract_csv():
    ...
    """
    df = pd.read_csv("/opt/airflow/dags/mock_supplier_data.csv")
...
def extract_sql():
    ...
    """
    conn = sqlite3.connect("/opt/airflow/dags/suppliers.db")
...
def transform_and_merge():
    ...
    df_sql = pd.read_pickle("/opt/airflow/dags/tmp/df_sql.pkl")
    ...
    output_path = "/opt/airflow/dags/merged_supplier_data.csv"
